import Vue from 'vue';
import iCityElement from './iChoiseCity.vue';
...
const showCity = function(options) {
	...
	instance.$on("address", function(res) {
		if(typeof onConfirm === 'function') {
			onConfirm(res || 'address');
		}
	})
}
